...
#RENAME TO PARSE_ROUTE_DATABASE

def parse_route_table(placemark: str, stops: bool = False, max_segments: int = None) -> list[SSInterval] | SSInterval:
    ...
    return SSInterval(segments[:max_segments])
